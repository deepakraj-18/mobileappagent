...
| QA060 | Funtouch background-survival testing — screen off, overnight, force-stop, reboot, WSS drop → FCM recovery; document breakages + whitelist fixes                                       | QA     | (Phase 1–3 done) | 1.0 | In Progress |
