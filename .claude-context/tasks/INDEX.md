...
| DB001 | `@op-engineering/op-sqlite` schema + migrations: `hub_outbox`, `hub_cache`, `event_log` (indexes on status/createdAt). **No user-data tables.** | DB | SC001 | 0.5 | In Progress |
