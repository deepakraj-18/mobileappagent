...
| BD034 | REST client — typed calls expecting the `~/.claude/rules/api-design.md` envelope + `error-handling.md` error shape; `GET /v1/companion/{cards,config}`, `POST /v1/companion/events` batch replay                                                  | BD     | BD031                      | 1.0 | In Progress |
