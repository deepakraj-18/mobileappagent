...
| BD030 | `HubClient` interface + `MockHubClient` (scripted scenarios for dev/tests) + `hub_outbox` (sqflite queue, FIFO, ack, replay-on-reconnect, cap/drop)                                                                                               | BD     | BD035, SC007               | 2.0 | In Progress |
