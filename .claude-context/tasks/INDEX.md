...
| ID    | Title                                                                                                                                                                                 | Stream | Dependencies     | Est | Status  |
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ---------------- | --- | ------- |
| FD060 | Onboarding — companion setup: a11y, notification access, **Vivo battery/auto-start whitelist walkthrough**, pair with the brain, set wake phrase, pick presence anchor, grant mic/BLE | FD     | FD030, FD041     | 1.5 | In Progress |
