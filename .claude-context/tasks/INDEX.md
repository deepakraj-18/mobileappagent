...
| BD052 | `NotificationListener.kt` + `notification_forwarder.dart` — forward incoming notifications to the hub (brain decides). Opt-in, off by default                                                                                                                                                                                                            | BD     | BD032, SC004                      | 1.5  | In Progress |
