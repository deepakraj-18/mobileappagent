...
| FD041 | Settings: fallback-provider form (base URL, key, model, test) + companion settings (wake phrase, "stay awake while charging", presence anchor picker, Vivo whitelist helper buttons) | FD     | SC002, BD041 | 1.25 | In Progress |
