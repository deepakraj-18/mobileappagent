...
| BD032 | `AzureHubClient` realtime channel — WSS (raw `web_socket_channel` or SignalR client, decide here), reconnect/backoff, heartbeat, rides the FGS; duplicate-delivery idempotency by messageId                                                       | BD     | BD031                      | 2.5 | In Progress |
