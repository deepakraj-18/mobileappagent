...
| ID    | Title                                                                                                                                                                                                                                                                                                                                                    | Stream | Dependencies                      | Est  | Status  |
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | --------------------------------- | ---- | ------- |
| BD050 | `AnnouncementQueue` — inbound `announce`; gate on presence + quiet hours (from hub `config`, local default); TTS via Embodiment; voice ack/snooze; fire-once semantics                                                                                                                                                                                   | BD     | BD032, BD004                      | 1.5  | In Progress |
