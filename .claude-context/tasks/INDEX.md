...
| IF002 | Device provisioning runbook: enable a11y, notification access, **Vivo auto-start / battery / background-power whitelist**, ADB install script | IF | — | 0.5 | In Progress |
