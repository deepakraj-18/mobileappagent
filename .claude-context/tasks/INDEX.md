...
| BD051 | `DockCardsController` — hold + render `card_push` (reminder/task/health/info cards); stale/offline marker from cache; display only                                                                                                                                                                                                                       | BD     | BD032, SC007                      | 1.0  | In Progress |
