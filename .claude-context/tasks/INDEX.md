...
| SC006 | Biometric app lock — `react-native-biometrics` (fingerprint + device-credential fallback); lock on resume; per-action gate hook; lock UI | SC | SC002 | 1.0 | In Progress |
