...
| ID    | Title                                                                                                                                                                                                                                    | Stream | Dependencies | Est  | Status  |
| ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------ | ---- | ------- |
| BD003 | `WakeWordService` — sherpa-onnx KWS, bundled model, duty-cycled start/stop with the FGS, wake-event stream; tap-to-talk fallback                                                                                                         | BD     | SC004        | 2.0  | In Progress |
